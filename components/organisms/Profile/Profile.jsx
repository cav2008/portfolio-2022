...
const Profile = () => (
  <Wrapper>
    <div className="bg-white p-4 lg:flex lg:flex-row-reverse lg:rounded-lg lg:shadow-lg lg:-mt-14 lg:mb-14 lg:p-10">
      ...
      <div className="text-center my-8 lg:my-0 lg:text-left">
        <p className="font-bold text-2xl lg:text-4xl">Hello &amp; Welcome!</p>
